...
// Function Ml Predictions
// document.getElementById('addml_partForm').addEventListener('submit', async (event) => {
//     event.preventDefault();
//     var mid_grade = document.getElementById('mic_grade').value;
//     var end_grade = document.getElementById('end_grade').value;
...
//         body: JSON.stringify({
//             input_data: [[
//                 mid_grade, end_grade, gender, status
//             ]]
//         })
//     })
//         .then(response => response.json())
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    ml_Form.addEventListener('submit', async (event) => {
        event.preventDefault();

        //const formData = new FormData(ml_Form);
        // const userData = Object.fromEntries(formData.entries());
        var mid_grade = document.getElementById('mid_grade').value;
        var end_grade = document.getElementById('end_grade').value;
        var gender = document.getElementById('gender').value;
        var status = document.getElementById('status').value;
